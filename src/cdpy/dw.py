...
class CdpyDw(CdpSdkBase):
    ...
    def create_cluster(self, env_crn: str, overlay: bool, aws_lb_subnets: list = None,
        ...
        if all(x is not None for x in [az_subnet, az_enable_az, az_managed_identity]):
            ...
            azure_options = {k: v for k,
                             v in azure_options_all.items() if v is not None}
        else:
            azure_options = None
        return self.sdk.call(
    ...
    def create_data_visualization(self, cluster_id: str, name: str, config: dict = None, template_name: str = None, image_version: str = None):
        return self.sdk.call(
